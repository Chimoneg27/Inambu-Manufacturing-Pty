...
namespace InambuManufacturingPty.Migrations
{
    ...
    [Migration("20260827024109_ApprovalHistoryModelChanges")]
    partial class ApprovalHistoryModelChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inambu_Manufacturing_Pty.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Inambu_Manufacturing_Pty.Models.ApprovalHistoryModel", b =>
                {
                    ...
                    b.ToTable("ApprovalHistoryModels");
                });
            ...
            modelBuilder.Entity("Inambu_Manufacturing_Pty.Models.ProductionLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inambu_Manufacturing_Pty.Models.MeasurementInputModel", b =>
                {
                    ...
                    b.HasOne("Inambu_Manufacturing_Pty.Models.ProductionLine", "ProductionLine")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Inambu_Manufacturing_Pty.Data.ApplicationUser", null)
                        .WithMany()
